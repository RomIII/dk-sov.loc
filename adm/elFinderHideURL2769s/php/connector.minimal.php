<?php
if (isset($_SESSION['kod']) && $_SESSION['kod'] != '') exit ("Ошибка регистрации");
...
$opts = array(
    ...
    'roots' => array(
        array(
            ...
            'path' => '../../../uploads/site/',                 // path to files (REQUIRED)
            'URL' => '/uploads/site/', // URL to files (REQUIRED)
            //'URL'           => dirname($_SERVER['PHP_SELF']) . '/uploads/files/', // URL to files (REQUIRED)
